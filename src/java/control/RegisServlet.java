 ...
 * @author asus
 */
@WebServlet(name = "RegisServlet", urlPatterns = {"/regis"})
public class RegisServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet RegisServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet RegisServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        processRequest(request, response);
        ...
        User u = ud.getUserByNameEmail(name, email);
        if (u != null) {
            request.setAttribute("msg", " Tên và email đã tồn tại! ");
        } else {
